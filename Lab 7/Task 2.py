...
pygame.mixer.init()
path = 'C:\Users\Zafar\Documents\python\Katalog\Python Labs\Music'
songList = ['Dj_Snake_Justin_Bieber_-_Let_Me_Love_You.mp3',
            'EZI-Afraid Of The Dark.mp3',
            'Hailee_Steinfield_Bloodpop_-_Capital Letters.mp3']
